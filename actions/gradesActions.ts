'use server';
import { Note, NotesByCountry, NotesPaginationResponse, QuantityInfo, StudentsByYearResponse } from "@/index";
import { getFilteredNotes, getQuantityInfo, getStudentsByYear } from "@/services/backend/notas";
